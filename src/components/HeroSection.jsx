        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.15fr 0.85fr', gap: '3.5rem', alignItems: 'center' }} className="hero-grid">
          ...
          <div>
            ...
            <p style={{ 
              ...
              <strong style={{ color: 'var(--text-primary)' }}>Zayrath Group</strong> is an avant-garde enterprise conglomerate shaping the future of global commerce. Through dedicated powerhouse subsidiaries, we deliver world-class <strong style={{ color: 'var(--text-gold)' }}>IT Hardware & Enterprise Products</strong> alongside tailored <strong style={{ color: 'var(--text-gold)' }}>Full-Cycle Software & AI Solutions</strong>.
            </p>
            ...
            >
              <div>
                <div style={{ fontFamily: 'var(--font-heading)', fontSize: '1.85rem', fontWeight: 800, color: 'var(--text-gold)' }}>
                  10,000+
                </div>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div 
              ...
              style={{
                ...
                boxShadow: '0 20px 45px rgba(15, 23, 42, 0.08), 0 0 30px rgba(184, 134, 11, 0.15)'
              }}
            >
              {/* Brand Emblem Frame */}
              <div 
                style={{
                  ...
                  borderRadius: '24px',
                  padding: '6px',
                  background: 'linear-gradient(135deg, #D4AF37 0%, rgba(184, 134, 11, 0.25) 50%, #B8860B 100%)',
              ...
              <div style={{ fontFamily: 'var(--font-serif)', fontSize: '1.75rem', fontWeight: 800, letterSpacing: '0.08em', color: 'var(--text-primary)' }}>
                ZAYRATH GROUP
              </div>
              <div style={{ fontSize: '0.8rem', letterSpacing: '0.3em', color: 'var(--text-gold)', textTransform: 'uppercase', marginBottom: '1.5rem', fontWeight: 700 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', textAlign: 'left' }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
                    <div style={{ background: 'rgba(184, 134, 11, 0.12)', padding: '0.65rem', borderRadius: '8px', color: 'var(--text-gold)' }}>
                      <Server size={22} />
                    </div>
                    <div>
                      <div style={{ fontWeight: 700, fontSize: '0.95rem', color: 'var(--text-primary)' }}>Zayrath Tech Systems</div>
                      <div style={{ fontSize: '0.78rem', color: 'var(--text-gold)', fontWeight: 600 }}>Open IT Products Page →</div>
                    </div>
                  </div>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
                    ...
                    <div>
                      <div style={{ fontWeight: 700, fontSize: '0.95rem', color: 'var(--text-primary)' }}>Zayrath Software Solutions</div>
                      <div style={{ fontSize: '0.78rem', color: 'var(--text-gold)', fontWeight: 600 }}>Open Software Solutions Page →</div>
                    </div>
                  </div>
                  <ChevronRight size={18} style={{ color: 'var(--gold-primary)' }} />
                </div>
